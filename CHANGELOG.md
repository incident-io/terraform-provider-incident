...
- Every claimable resource takes `unlock_in_dashboard`. Set it and Terraform manages the resource without claiming it, so people can still edit it in the dashboard. Pair it with `ignore_changes` or the next apply reverts those edits.
