...
- `array_value` (Attributes Set) If array_value is set, this helps render the values (see [below for nested schema](#nestedatt--alert_sources--template--visible_to_teams--array_value))
