...
- `id` (String) ID of the grouping key
- `reference` (Attributes) Reference to the attribute (see [below for nested schema](#nestedatt--incident_config--grouping_keys--reference))

<a id="nestedatt--incident_config--grouping_keys--reference"></a>
### Nested Schema for `incident_config.grouping_keys.reference`

Required:

- `array` (Boolean) Whether this is an array
- `key` (String) Key of the attribute
- `label` (String) Label for the attribute
...
- `name_autogenerated` (Boolean) Whether the name is autogenerated or not
...
- `summary_autogenerated` (Boolean) Whether the summary is autogenerated or not
...
- `array_value` (Attributes Set) The array of literal or reference parameter values (see [below for nested schema](#nestedatt--incident_template--name--array_value))
...
- `array_value` (Attributes Set) The array of literal or reference parameter values (see [below for nested schema](#nestedatt--incident_template--summary--array_value))
