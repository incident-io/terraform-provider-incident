...
- `form_fields` (Attributes List) The form fields shown to the user when manually triggering this workflow (see [below for nested schema](#nestedatt--form_fields))
...
- `array` (Boolean) Whether this form field accepts multiple values
- `name` (String) Human readable label shown to the user for this form field
- `required` (Boolean) Whether a value must be provided for this form field
- `type` (String) The engine type of the value this form field collects

Optional:

- `default_value` (Attributes) The default value to pre-populate this form field with (see [below for nested schema](#nestedatt--form_fields--default_value))
- `description` (String) Longer description displayed below the form field label
- `id` (String) Unique identifier for this form field
- `placeholder` (String) Placeholder text shown in the form field before a value is entered

<a id="nestedatt--form_fields--default_value"></a>
### Nested Schema for `form_fields.default_value`

Optional:

- `array_value` (Attributes List) The array of literal or reference parameter values (see [below for nested schema](#nestedatt--form_fields--default_value--array_value))
- `value` (Attributes) The literal or reference parameter value (see [below for nested schema](#nestedatt--form_fields--default_value--value))

<a id="nestedatt--form_fields--default_value--array_value"></a>
### Nested Schema for `form_fields.default_value.array_value`
...
<a id="nestedatt--form_fields--default_value--value"></a>
### Nested Schema for `form_fields.default_value.value`
