resource "incident_alert_route_v3" "service_alerts" {
  ...
  // Grouping configuration controls how alerts are grouped together. In v3 this
  // is configured here rather than on incident_config.
  grouping_config = {
    default = {
      enabled = true
  ...
  // auto_decline_enabled is used to specify whether or not triage incidents should be automatically declined
  ...
  incident_config = {
    ...
    // v3 the template is nested under incident_config.
    template = {
