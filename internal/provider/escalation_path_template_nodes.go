...
// escalationPathTemplateNodeAttrTypes is escalationPathNodeAttrTypes with the template's
...
// escalationPathTemplateNodeSchema is escalationPathNodeSchema with the template's
// targets in its level and notify_channel blocks.
func escalationPathTemplateNodeSchema() schema.NestedAttributeObject {
	node := escalationPathNodeSchema()
...
func (templateSequenceCodec) LeafPayload(ctx context.Context, id string, node escalationPathNode, diags *diag.Diagnostics) (client.EscalationPathTemplateNodePayloadV2, bool) {
...
func (templateSequenceCodec) Leaf(ctx context.Context, node client.EscalationPathTemplateNodeV2, diags *diag.Diagnostics) (escalationPathNode, bool) {
...
func reconcileTemplateBindingSpelling(ctx context.Context, sequences, prior map[string][]escalationPathNode, diags *diag.Diagnostics) {
