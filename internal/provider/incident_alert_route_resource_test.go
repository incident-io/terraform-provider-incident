	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create alert route with owning_team_ids
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("incident_alert_route.test", "name", "test-route-with-teams"),
			...
			// Update to add another team
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("incident_alert_route.test", "name", "test-route-with-multiple-teams"),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Apply with a raw (non-HTML-escaped) literal containing '>'.
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestMatchResourceAttr("incident_alert_route.test", "id", regexp.MustCompile("^[a-zA-Z0-9]+$")),
					resource.TestCheckResourceAttr("incident_alert_route.test", "name", "raw-json-literal-test"),
				),
			},
