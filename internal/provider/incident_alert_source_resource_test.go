		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("incident_alert_source.test", "email_options.redactions.0", "credit_card_numbers"),
					resource.TestCheckResourceAttr("incident_alert_source.test", "email_options.redactions.1", "phone_numbers"),
