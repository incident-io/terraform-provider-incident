...
func TestAlertRouteV3RoundTrip(t *testing.T) {
	...
	if got := payload.GroupingConfig.Default.WindowType; got != client.Fixed {
		t.Errorf("payload window_type: got %q", got)
	}
