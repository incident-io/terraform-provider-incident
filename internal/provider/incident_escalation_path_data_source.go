...
func NewEscalationPathDataSource() datasource.DataSource {
...
func (d *EscalationPathDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Look up an escalation path by `id` or `name`, read as a flat map of named node sequences. Exactly one lookup field should be set.",
