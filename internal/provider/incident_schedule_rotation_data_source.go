...
// NewIncidentScheduleRotationBetaDataSource registers this data source under the name it
// had in v6. See aliases.go.
func NewIncidentScheduleRotationBetaDataSource() datasource.DataSource {
	return &IncidentScheduleRotationDataSource{betaAlias: scheduleRotationBetaAlias}
}
...
func (d *IncidentScheduleRotationDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = d.typeName(req.ProviderTypeName, "_schedule_rotation")
}
...
func (d *IncidentScheduleRotationDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: d.description("Look up a rotation on a schedule by `id` or `name`. Exactly one lookup field should be set."),
