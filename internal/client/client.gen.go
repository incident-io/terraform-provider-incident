...
type AlertRouteIncidentTemplatePayloadV2 struct {
	...
	// NameAutogenerated Whether the name is autogenerated or not
	NameAutogenerated *bool                               `json:"name_autogenerated,omitempty"`
	...
	// SummaryAutogenerated Whether the summary is autogenerated or not
	SummaryAutogenerated *bool                        `json:"summary_autogenerated,omitempty"`
...
type AlertRouteIncidentTemplateV2 struct {
	...
	StartInTriage     *EngineParamBindingV2        `json:"start_in_triage,omitempty"`
...
type AlertRouteV2 struct {
	...
	AlertSources *[]AlertRouteAlertSourceV2 `json:"alert_sources,omitempty"`

	// ChannelConfig The channel configuration for this alert route
	ChannelConfig *[]AlertRouteChannelConfigV2 `json:"channel_config,omitempty"`

	// ConditionGroups What condition groups must be true for this alert route to fire?
	ConditionGroups *[]ConditionGroupV2 `json:"condition_groups,omitempty"`
	...
	EscalationConfig *AlertRouteEscalationConfigV2 `json:"escalation_config,omitempty"`
	...
	IncidentConfig   *AlertRouteIncidentConfigV2   `json:"incident_config,omitempty"`
	IncidentTemplate *AlertRouteIncidentTemplateV2 `json:"incident_template,omitempty"`
...
type AlertRoutesListResultV2 struct {
	AlertRoutes    []AlertRouteV2         `json:"alert_routes"`
...
type GroupingKeyV2 struct {
	...
	Id        string             `json:"id"`
	Reference *EngineReferenceV2 `json:"reference,omitempty"`
}
